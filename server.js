...
app.post(
  ...
  (req, res) => {
    ...
    const topic =
      `${MQTT_PREFIX}/${deviceId}/cmd/settings-auth`;

    const replyTopic =
      `${MQTT_PREFIX}/${deviceId}/settings-auth-result`;
  ...
  (req, res) => {
    ...
    if (!password) {
      return res
        ...
        .json({
          error:
            "Current settings password is required"
        });
    }
    ...
    // NEW:
    // false = Room 1 Sauna / Room 2 Steam
    // true  = Room 1 Steam / Room 2 Sauna
    const reverseRooms =
      Boolean(
    ...
    // NEW:
    // Defaults to true for compatibility with older clients.
    const infraredUI =
      req.body?.infraredUI ===
      undefined
        ? true
    ...
    // ========================================================
    // BUILD SETTINGS PAYLOAD FOR ESP32
    // ========================================================
...
app.post(
  ...
  (req, res) => {
    ...
    const topic =
      `${MQTT_PREFIX}/${deviceId}/cmd/${command}`;
